class Solution {
    ...
    private int solve(int r1,int c1,int r2,int c2,int[][] grid){
        ...
        int t1=solve(r1-1,c1,r2-1,c2,grid);
        int t2=solve(r1,c1-1 , r2 ,c2-1,grid);
        int t3=solve(r1-1,c1,r2,c2-1,grid);
        int t4=solve(r1,c1-1,r2-1,c2,grid);
    ...
    public int cherryPickup(int[][] grid) {
        ...
        int ans=solve(n-1,n-1,n-1,n-1,grid);
